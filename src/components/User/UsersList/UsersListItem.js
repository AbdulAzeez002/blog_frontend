      ...
      <div className="p-8 mx-10 mb-4 bg-white shadow-xl rounded border border-black">
        <div className="flex flex-wrap justify-between items-center -mx-4">
          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0">
            <p className="inline-block py-1 px-2 mr-2 mb-1 lg:mb-0 text-xs border-2 rounded-lg">
            ...
            <Link
              ...
              className=" text-white   py-1 px-2 bg-emerald-700 text-center mr-2 mb-1 lg:mb-0 text-lg border-2  rounded-lg "
            >
              Profile
            </Link>
            ...
            {user?.user?.isBlocked ? (
              <button
                ...
                className="inline-block py-1 px-4 text-center bg-gray-500 text-white mr-2 mb-1 lg:mb-0 text-lg border rounded-lg"
              >
                unblock
              </button>
            ) : (
              <button
                ...
                className="inline-block py-1 px-4 text-center bg-rose-700 text-white mr-2 mb-1 lg:mb-0 text-lg border rounded-lg"
              >
                Block
              </button>
            )}
