                  ...
                  postLists && postLists?.map((post, index) => (
                    <div class="flex flex-wrap shadow-xl bg-[#F1F5F9]  lg:mb-6 border border-gray-400 rounded-xl mr-10 p-10">
                      ...
                      <div class="w-full lg:w-3/4 px-3 mt-10 lg:mt-0 ">
                        <a onClick={()=>navigate('/postDetails',{state:{id:post?._id}})}  class=" hover:underline cursor-pointer">
                        ...
                        {/* Read more */}
                        <a onClick={()=>navigate('/postDetails',{state:{id:post?._id}})} className="text-indigo-500 hover:underline cursor-pointer">
